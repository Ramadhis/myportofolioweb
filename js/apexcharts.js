          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if ((z.attr("index", s), v && z.attr({ "clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")") }), "none" !== A.config.states.normal.filter.type)) S.getDefaultFilter(z, s);
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var h = o;
              if (
                (-1 === o.indexOf("rgb") ? o.length < 9 && (h = p.hexToRgba(o, l)) : o.indexOf("rgba") > -1 && (l = p.getOpacityFromRGBA(o)),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              Array.isArray(s.fill.pattern.style)
                ? (t = void 0 !== s.fill.pattern.style[r.seriesNumber] ? o.drawPattern(s.fill.pattern.style[r.seriesNumber], s.fill.pattern.width, s.fill.pattern.height, l, n, i) : a)
              ...
              if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length)
                a =
                  "dark" === s.fill.gradient.shade
                    ? n.shadeColor(-1 * parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? p.rgb2hex(t) : t)
                    : n.shadeColor(parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? p.rgb2hex(t) : t);
                ...
                for (var d = 0; d < l.x.length; d++) {
                  ...
                  if (f || r) {
                    ...
                    o.config.series[n].data[g] &&
                      (o.config.series[n].data[g].fillColor && (v.pointFillColor = o.config.series[n].data[g].fillColor), o.config.series[n].data[g].strokeColor && (v.pointStrokeColor = o.config.series[n].data[g].strokeColor)),
                      a && (v.pSize = a),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, o) {
              ...
              a = p.pSize;
              var v,
                m = d.fillPath({ seriesNumber: s, dataPointIndex: r, color: p.pointFillColor, patternUnits: "objectBoundingBox", value: n.globals.series[s][o] });
              if (
                ("circle" === p.shape ? (v = u.drawCircle(i)) : ("square" !== p.shape && "rect" !== p.shape) || (v = u.drawRect(0, 0, p.width - p.pointStrokeWidth / 2, p.height - p.pointStrokeWidth / 2, p.pRadius)),
              ...
              if (!this.initialAnim || n.globals.dataChanged || n.globals.resized) n.globals.animationEnded = !0;
                ...
                h.animateMarker(v, 0, "circle" === p.shape ? a : { width: p.width, height: p.height }, w, n.globals.easing, function () {
              ...
              if (n.globals.dataChanged && "circle" === p.shape)
                if (this.dynamicAnim) {
                  ...
                  0 === t && 0 === e && (a = 0), h.animateCircle(v, { cx: k, cy: A, r: S }, { cx: t, cy: e, r: a }, T, n.globals.easing);
                } else v.attr({ r: a });
            ...
            value: function (t) {
              ...
              if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                ...
                ((("bar" === e.config.chart.type || "rangeBar" === e.config.chart.type) && e.config.plotOptions.bar.distributed) || e.config.dataLabels.distributed) && (v = e.globals.dataLabels.style.colors[o]),
                  "function" == typeof v && (v = v({ series: e.globals.series, seriesIndex: r, dataPointIndex: o, w: e })),
                  g && (v = g);
                var m = d.offsetX,
                  y = d.offsetY;
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              var M = { x: e, y: i, i: r, j: o, renderedPath: u, bcx: v, bcy: m, barHeight: h, barWidth: c, textRects: P, strokeWidth: x, dataLabelsX: y, dataLabelsY: w, barDataLabelsConfig: S, offX: C, offY: L };
              return (
                (k = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(M) : this.calculateColumnsDataLabelsPosition(M)),
                u.attr({ cy: k.bcy, cx: k.bcx, j: o, val: l[r][o], barHeight: h, barWidth: c }),
                this.drawCalculatedDataLabels({ x: k.dataLabelsX, y: k.dataLabelsY, val: this.barCtx.isRangeBar ? [a, s] : l[r][o], i: n, j: o, barWidth: c, barHeight: h, textRects: P, dataLabelsConfig: A })
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !v) {
                ...
                var m = "";
                void 0 !== s && (m = f(s, { seriesIndex: r, dataPointIndex: o, w: d }));
                ...
                this.barCtx.isHorizontal && s < 0 && ("start" === c.textAnchor ? (k.textAnchor = "end") : "end" === c.textAnchor && (k.textAnchor = "start")),
                  u.plotDataLabelsText({ x: i, y: a, text: m, i: r, j: o, parent: x, dataLabelsConfig: k, alwaysDrawDataLabel: !0, offsetCorrection: !0 });
              }
              return x;
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var x = e,
                ...
                m = d.line(a, v - r);
              return (
                (p = p + d.line(u.x2, x) + u.pathWithRadius + d.line(u.x2, v - r) + m + m + "z"),
                ...
                if ((Math.abs(e.x1 - e.x2) < o && (o = Math.abs(e.x1 - e.x2)), void 0 !== i[a][s] || null !== i[a][s])) {
                  ...
                  d && (o *= -1),
                    ...
                    (h =
                      ...
                      r.quadraticCurve(c + o, e.barYPosition + e.barHeight - e.strokeWidth, c, e.barYPosition + e.barHeight - e.strokeWidth));
                }
        ...
        r(t, [
          {
            ...
            value: function (t, i) {
              ...
              for (var n = 0, l = 0; n < t.length; n++, l++) {
                ...
                for (var C = s.group({ class: "apexcharts-datalabels", "data:realIndex": m }), L = s.group({ class: "apexcharts-bar-goals-markers", style: "pointer-events: none" }), P = 0; P < a.globals.dataPoints; P++) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              T.count > 0 && s >= S.globals.dataPoints - T.count && (P.node.setAttribute("stroke-dasharray", T.dashArray), P.node.setAttribute("stroke-width", T.strokeWidth), P.node.setAttribute("fill-opacity", T.fillOpacity)),
                ...
                h.add(P);
              var M = new I(this).handleBarDataLabels({ x: c, y: d, y1: g, y2: u, i: r, j: s, series: p, realIndex: e, barHeight: f, barWidth: v, barYPosition: m, renderedPath: P, visibleSeries: k });
                ...
                for (var y = s.group({ class: "apexcharts-datalabels", "data:realIndex": u }), w = s.group({ class: "apexcharts-rangebar-goals-markers", style: "pointer-events: none" }), k = 0; k < a.globals.dataPoints; k++) {
                  ...
                  if (((g = m.yDivision), (x = m.barHeight), this.isHorizontal)) {
                    ...
                    if (a.config.series[o].data[k].x) {
                      var z = this.detectOverlappingBars({ i: o, j: k, barYPosition: P, srty: I, barHeight: x, yDivision: g, initPositions: m });
                      (x = z.barHeight), (P = z.barYPosition);
                    }
                    v = (L = this.drawRangeBarPaths(e({ indexes: { i: o, j: k, realIndex: u }, barHeight: x, barYPosition: P, zeroW: h, yDivision: g, y1: S, y2: C }, T))).barWidth;
                  } else x = (L = this.drawRangeColumnPaths(e({ indexes: { i: o, j: k, realIndex: u }, zeroH: l, barWidth: v, xDivision: n }, T))).barHeight;
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              if (a && "object" === i(a)) {
                var l = {};
                (l =
                  -1 !== ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type)
                    ? r[a.chart.type]()
                    : r.line()),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = this.w;
              return (
                p.isNumber(t) && (t = 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0)), t
              );
            },
          },
          {
                          ...
                          for (var s = 0; s < t.data.length; s++) {
                            ...
                            ("candlestick" === o.config.chart.type || (t.type && "candlestick" === t.type)) &&
                              ...
                              ("boxPlot" === o.config.chart.type || (t.type && "boxPlot" === t.type)) &&
                                (n.pop(), n.push(o.globals.seriesCandleO[e][s]), n.push(o.globals.seriesCandleH[e][s]), n.push(o.globals.seriesCandleM[e][s]), n.push(o.globals.seriesCandleL[e][s]), n.push(o.globals.seriesCandleC[e][s])),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (0 === e && l.globals.skipFirstTimelinelabel) ||
                ...
                (l.config.grid.xaxis.lines.show && this._drawGridLine({ x1: i, y1: a, x2: s, y2: r, parent: n }), new G(this.ctx).drawXaxisTicks(i, this.elg));
            },
          },
          {
            key: "_drawGridLine",
                ...
                for (var g = 0; g < r.series[d].length; g++) {
                  ...
                  null !== u && p.isNumber(u)
                    ? (void 0 !== c[d][g] && ((o = Math.max(o, c[d][g])), (e = Math.min(e, c[d][g]))),
                      ...
                      p.isFloat(u) && ((u = p.noExponents(u)), (r.yValueDecimal = Math.max(r.yValueDecimal, u.toString().split(".")[1].length))),
            ...
            value: function () {
              ...
              if (t.config.xaxis.crosshairs.show) {
                ...
                (!p.isNumber(A) || A < 0) && (A = 0),
                  ...
                  d && (w = i.dropShadow(w, { left: g, top: u, blur: f, color: v, opacity: m })),
                ...
                e.config.yaxis.map(function (r, o) {
                  ...
                  if ((!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (l = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && n.result.length)) {
                    ...
                    g !== u && (y = x.getTextRects(u, r.labels.style.fontSize, r.labels.style.fontFamily, v, !1)),
                      i.push({ width: (l > y.width || l > m.width ? l : y.width > m.width ? y.width : m.width) + a, height: y.height > m.height ? y.height : m.height });
            ...
            value: function () {
              ...
              for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                ...
                e.config.legend.showForNullSeries ||
                  ...
                  b.setAttrs(L, { rel: l + 1, seriesName: p.escapeString(a[l]), "data:collapsed": c || d }),
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                { capturedSeries: v, j: r.globals.isBarHorizontal ? x : f, hoverX: g, hoverY: u }
              );
            },
          },
          {
              ...
              for (
                var n = this.graphics.group({ class: "apexcharts-bar-series apexcharts-plot-series" }),
                  ...
                  c = function (r, o) {
                    ...
                    var v = a.graphics.group({ class: "apexcharts-series", seriesName: p.escapeString(s.globals.seriesNames[b]), rel: r + 1, "data:realIndex": b });
                    ...
                    for (var A = 0; A < s.globals.dataPoints; A++) {
                      var S = a.barHelpers.getStrokeWidth(r, A, b),
                        ...
                        L = null;
                      a.isHorizontal
                        ? ((L = a.drawStackedBarPaths(e(e({}, C), {}, { zeroW: u, barHeight: y, yDivision: d }))), (w = a.series[r][A] / a.invertedYRatio))
                        : ((L = a.drawStackedColumnPaths(e(e({}, C), {}, { xDivision: c, barWidth: w, zeroH: g }))), (y = a.series[r][A] / a.yRatio[a.yaxisIndex])),
                        (h = L.y),
                        (l = L.x),
                        f.push(l),
                        x.push(h);
                    ...
                    for (
                      var A = r.group({ class: "apexcharts-datalabels", "data:realIndex": v }),
                        S = function (i) {
                          ...
                          (l = a.isHorizontal ? a.drawHorizontalBoxPaths(e(e({}, p), {}, { yDivision: c, barHeight: y, zeroW: g })) : a.drawVerticalBoxPaths(e(e({}, p), {}, { xDivision: h, barWidth: w, zeroH: d }))),
                            (f = l.y),
                            (u = l.x),
                            i > 0 && b.push(u + w / 2),
                            x.push(f),
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              ...
              var l = n.color,
                h = new p();
              return (
                s.config.plotOptions[t].enableShades && (l = "dark" === this.w.config.theme.mode ? p.hexToRgba(h.shadeColor(-1 * r, n.color), s.config.fill.opacity) : p.hexToRgba(h.shadeColor(r, n.color), s.config.fill.opacity)),
              ...
              for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
                ...
                for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, f = 0; f < l[h].length; f++) {
                  ...
                  if (
                    ...
                    c.add(k),
                    k.attr({ fill: m, i: h, index: h, j: f, val: l[h][f], "stroke-width": this.strokeWidth, stroke: e.config.plotOptions.heatmap.useFillColorAsStroke ? m : e.globals.stroke.colors[0], color: m }),
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                n.attr({ transform: "translate(".concat(m, ", ").concat(y, ") scale(").concat(f, ")") }),
                n.add(k),
                this.ret.add(n),
            ...
            value: function (t, e) {
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                "pie" === this.chartType || "polarArea" === this.chartType
                  ? (w = p.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (n + u / 2) % this.fullAngle))
                  : "donut" === this.chartType && (w = p.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (n + u / 2) % this.fullAngle)),
                  g.add(m);
                var k = 0;
                if (
                  ...
                  this.dynamicAnim && i.globals.dataChanged
                    ...
                    : this.animatePaths(m, { size: this.sliceSizes[d], endAngle: h, startAngle: n, i: d, totalItems: t.length - 1, animBeginArr: this.animBeginArr, dur: k }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return "donut" === e.chartType
                ? [].concat(b, ["L", u.x, u.y, "A", e.donutSize, e.donutSize, 0, x, 0, f.x, f.y, "L", h, c, "z"]).join(" ")
                ...
                t.forEach(function (t, n) {
                  ...
                  for (var v = 0; v < c.linePathsTo.length; v++) {
                    var m = i.graphics.renderPaths(
                      e(e({}, d), {}, { pathFrom: null === b ? c.linePathsFrom[v] : b, pathTo: c.linePathsTo[v], strokeWidth: Array.isArray(i.strokeWidth) ? i.strokeWidth[n] : i.strokeWidth, fill: "none", drawShadow: !1 })
                    );
                    h.add(m);
                    var y = s.fillPath({ seriesNumber: n }),
                      w = i.graphics.renderPaths(e(e({}, d), {}, { pathFrom: null === b ? c.areaPathsFrom[v] : b, pathTo: c.areaPathsTo[v], strokeWidth: 0, fill: y, drawShadow: !1 }));
                  ...
                  t.forEach(function (t, s) {
                    var r = new P(i.ctx).getMarkerConfig({ cssClass: "apexcharts-marker", seriesIndex: n, dataPointIndex: s }),
            ...
            value: function (t) {
              ...
              for (var v = f ? t.series.length - 1 : 0; f ? v >= 0 : v < t.series.length; f ? v-- : v++) {
                ...
                var y = a.fillPath({ seriesNumber: v, size: t.size, value: t.series[v] }),
                  ...
                  C = void 0;
                e.globals.dataChanged && ((k = this.startAngle), (C = Math.round((this.totalAngle * p.negToZero(e.globals.previousPaths[v])) / 100) + k)),
                ...
                var P = S - w,
                  ...
                  M = i.drawPath({ d: "", stroke: y, strokeWidth: o, fill: "none", fillOpacity: e.config.fill.opacity, classes: "apexcharts-radialbar-area apexcharts-radialbar-slice-" + v, strokeDashArray: T });
                if ((b.setAttrs(M.node, { "data:angle": P, "data:value": t.series[v] }), e.config.chart.dropShadow.enabled)) {
                  var I = e.config.chart.dropShadow;
                  s.dropShadow(M, I, v);
                }
                s.setSelectionFilter(M, 0, v), this.addListeners(M, this.radialDataLabels), m.add(M), M.attr({ index: 0, j: v });
                var z = 0;
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              (this.xDivision = a.globals.gridWidth / (a.globals.dataPoints - ("on" === a.config.xaxis.tickPlacement ? 1 : 0))),
                ...
                (this.elSeries = s.group({ class: "apexcharts-series", seriesName: p.escapeString(a.globals.seriesNames[i]) })),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (o.config.stroke.show && !this.pointsChart) {
                var v = null;
                v = "line" === i ? l.fillPath({ seriesNumber: a, i: s }) : o.globals.stroke.colors[a];
                for (var m = 0; m < r.linePaths.length; m++) {
                  var y = e(e({}, u), {}, { pathFrom: r.pathFromLine, pathTo: r.linePaths[m], stroke: v, strokeWidth: this.strokeWidth, strokeLineCap: o.config.stroke.lineCap, fill: "none" }),
                    w = n.renderPaths(y);
            ...
            value: function (t) {
              for (
                var e = t.series,
                  ...
                  A = l.pathFromLine,
                  S = l.pathFromArea,
                  C = p.isNumber(x.globals.minYArr[i]) ? x.globals.minYArr[i] : x.globals.minY,
            ...
            value: function (t) {
              ...
              if ((Array.isArray(p.config.stroke.curve) && (x = Array.isArray(u) ? p.config.stroke.curve[u[i]] : p.config.stroke.curve[i]), "smooth" === x)) {
                ...
                p.globals.hasNullValues
                  ? (null !== e[i][s] &&
                      (null !== e[i][s + 1]
                        ? ((h = f.move(n, l) + f.curve(n + m, l, r - m, o, r + 1, o)), (c = f.move(n + 1, l) + f.curve(n + m, l, r - m, o, r + 1, o) + f.line(r, v) + f.line(n, v) + "z"))
                        : ((h = f.move(n, l)), (c = f.move(n, l) + "z"))),
                    d.push(h),
                    g.push(c))
                  : ((h += f.curve(n + m, l, r - m, o, r, o)), (c += f.curve(n + m, l, r - m, o, r, o))),
                  (n = r),
                  (l = o),
                  s === e[i].length - 2 && ((c = c + f.curve(n, l, r, o, r, v) + f.move(r, o) + "z"), p.globals.hasNullValues || (d.push(h), g.push(c)));
              } else {
                if (null === e[i][s + 1]) {
                  h += f.move(r, o);
                ...
                null === e[i][s] && ((h += f.move(r, o)), (c += f.move(r, v))),
                  ...
                  s === e[i].length - 2 && ((c = c + f.line(r, v) + f.move(r, o) + "z"), d.push(h), g.push(c));
              }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              0 === e.minHour && 1 === e.minDate
                ? ((d = 0), (g = p.monthMod(e.minMonth)), (n = "month"), (h = e.minDate), r++)
                : 1 !== e.minDate && 0 === e.minHour && 0 === e.minMinute && ((d = 0), (l = e.minDate), (g = l), (u = c((h = l), i, a))),
                this.timeScaleArray.push({ position: d, value: g, unit: n, year: this._getYear(a, u, 0), month: p.monthMod(u), day: h });
          ...
          },
          {
            ...
            value: function (t) {
              for (
                ...
                d >= 60 && ((d = 0), 24 === (x += 1) && (x = 0)), this.timeScaleArray.push({ position: b, value: d, unit: "minute", hour: x, minute: d, day: g, year: this._getYear(f, u, 0), month: p.monthMod(u) }), (b += l), d++;
            },
          },
          {
            ...
            value: function (t) {
              for (
                ...
                c >= 60 && ((c = 0), ++d >= 60 && ((d = 0), 24 === ++x && (x = 0))),
                  this.timeScaleArray.push({ position: b, value: c, unit: "second", hour: x, minute: d, second: c, day: g, year: this._getYear(f, u, 0), month: p.monthMod(u) }),
                  (b += l),
                  c++;
            },
          },
            ...
            value: function () {
              ...
              var i = p.getDimensions(this.el),
                a = e.chart.width
                  ...
                  .pop();
              "%" === a
                ? p.isNumber(i[0]) && (0 === i[0].width && (i = p.getDimensions(this.el.parentNode)), (t.svgWidth = (i[0] * parseInt(e.chart.width, 10)) / 100))
                  ...
                  (i.config.chart.events.selection = function (t, s) {
                    a.forEach(function (t) {
                      ...
                      var n = a.w.config.yaxis.reduce(function (t, i, s) {
                        return [].concat(g(t), [e(e({}, a.w.config.yaxis[s]), {}, { min: r[0].min, max: r[0].max })]);
                      }, []);
                  ...
                  l.forEach(function (r, h) {
                    ...
                    return (
                      ...
                      t &&
                        ...
                        o &&
                          ((c.globals.lastXAxis = t.xaxis ? p.clone(t.xaxis) : []),
